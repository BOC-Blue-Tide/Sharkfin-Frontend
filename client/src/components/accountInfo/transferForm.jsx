      ...
      const firstPage = () => {
          return (
              <Box key="firstPage" display="flex" flexDirection="column" sx={style.gridCard}>
                  ...
                  <Button onClick={() => setPage(page + 1)} variant="contained" color="primary">
      ...
      const SecondPage = () => (
        ...
        const ThirdPage = () => (
            <Box display="flex" flexDirection="column" sx={style.gridCard}>
                ...
                <Typography variant="body2" >You are about to transfer <Box fontWeight='fontWeightMedium' display='inline'>${transferAmount}</Box> from your linked bank account ending in  <Box fontWeight='fontWeightMedium' display='inline'>{accountNumberTrimmer()}</Box>. Are you sure you want to proceed?</Typography>
